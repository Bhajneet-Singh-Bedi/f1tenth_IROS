...
class StanleyAvoidance(Node):
    def __init__(self):
        ...
        self.declare_parameter("waypoints_path", "/home/bhajneet/sim_racing/ros2_ws/src/stanley_avoidance/racelines/first_map.csv")
        self.declare_parameter("waypoints_path_2nd", "/home/bhajneet/sim_racing/ros2_ws/src/stanley_avoidance/racelines/first_map.csv")
        ...
        self.drive_pub = self.create_publisher(AckermannDriveStamped, self.drive_topic, 2)
    ...
    def drive_to_target(self, point, K_p):
        ...
        # angle = angle ** 1.5
        # determine velocity
        # Adjust K_p dynamically based on distance L
        if L < 2.0:  # If the point is closer
            angle = angle * 15  # Increase the gain for sharper turns
        elif L > 5.0:  # If the point is farther away
            angle = angle * 0.75  # Decrease the gain for smoother turns
        else:
            angle = angle
